...
vim.keymap.set("n", "<leader>sf", "<cmd>FzfLua files resume=true<CR>", { desc = "[S]earch [F]iles" })
vim.keymap.set("n", "<leader>sg", "<cmd>FzfLua live_grep_resume<CR>", { desc = "[S]earch [G]rep" })
vim.keymap.set("n", "<leader>b", "<cmd>FzfLua buffers<CR>", { desc = "[S]earch [B]uffers" })
